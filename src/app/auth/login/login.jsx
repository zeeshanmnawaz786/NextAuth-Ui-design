...
function Login() {
  return (
    <div>
      <div class="w-[400px] max-w-xs">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2" for="uemail">
              Emial
            </label>
            <input
          ...
          <div>
            <button class="bg-white border border-gray-300 rounded-md mt-3 py-2 w-full px-4 flex items-center">
              <svg
                class="h-5 w-5 mr-2"
                viewBox="0 0 24 24"
